...
Una vez que este activado el entorno virtual con el comando “pip install –r requirements.txt” instalamos todas las dependencias necesarias en la versión que se usaron para crear el ejerció 10
